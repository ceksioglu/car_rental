...
public class Book {
    ...
    private String name;
    private String idno;
    private String mpno; //Mobile Phone No
    private String mail;
    ...
    public Book(int id, int prc, String note, String bCase, LocalDate fnsh_date, LocalDate strt_date, String mail, String idno, String mpno, String name, int car_id, Car car) {
        this.id = id;
        this.prc = prc;
        this.note = note;
        this.bCase = bCase;
